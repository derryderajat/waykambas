...
const services: { label: string; detail: string }[] = [
  { label: 'Jungle Trekking', detail: 'Menyusuri hutan hujan tropis dengan pemandu bersertifikat' },
  { label: 'Elephant Safari', detail: 'Mengamati gajah & badak Sumatera dengan jeep 4x4' },
  { label: 'River Adventure', detail: 'Menyusuri sungai Waykambas dengan perahu tradisional' },
  { label: 'Bird Watching', detail: 'Mengamati 400+ spesies burung endemik bersama ornitolog' },
  { label: 'Camping Night', detail: 'Bermalam di hutan dengan pengalaman camping autentik' },
  { label: 'Paket Keluarga', detail: 'Tur yang aman & edukatif untuk semua usia' },
  { label: 'Private Guide', detail: 'Pemandu pribadi & tur yang dapat dikustomisasi' },
  { label: 'Bandara Transfer', detail: 'Penjemputan dari Bandara Radin Inten II Lampung' },
]
      ...
      >
        ...
        >
          <div style={{ flex: '1 1 500px' }}>
            ...
            >
              Dari trekking pagi di hutan hujan hingga berkemah di bawah
              langit berbintang, setiap detail tur Waykambas kami rancang
              dengan cermat. Berikut layanan yang tersedia:
            </p>
          </div>
          <div
            style={{
...
function OrbitalBadge() {
  ...
  useEffect(() => {
    ...
    const textContent = 'WAYKAMBAS \u2022 ADVENTURE TOUR \u2022 SINCE 2018 \u2022 '
