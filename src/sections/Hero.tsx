    ...
    >
      ...
      >
        ...
        >
          ...
          >
            WAYKAMBAS TOUR · Reservasi & Pertanyaan
          </p>
        </div>
      </div>
      ...
      >
        <div style={{ maxWidth: '520px', width: '100%', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          >
            Pesan paket tour atau kirim pertanyaan.
          </h3>
          ...
          {submitted ? (
            ...
            >
              ...
              <Row>
                <Field label="Tanggal mulai" type="date" name="checkin" value={formData.checkin} onChange={handleChange} />
                <Field label="Tanggal selesai" type="date" name="checkout" value={formData.checkout} onChange={handleChange} />
              </Row>
              <Row>
                <Field label="Jumlah peserta" type="number" name="guests" placeholder="2" min={1} value={formData.guests} onChange={handleChange} />
                <SelectField
                  label="Paket tour"
                  name="roomType"
              ...
              <Field label="Nama lengkap" type="text" name="name" placeholder="Nama Anda" value={formData.name} onChange={handleChange} />
              <Field label="Email" type="email" name="email" placeholder="email@anda.com" value={formData.email} onChange={handleChange} />
              <TextareaField
                label="Pesan (opsional)"
                name="message"
                placeholder="Kebutuhan khusus, pertanyaan, atau permintaan tambahan…"
              ...
              >
                {createReservation.isPending ? 'Mengirim...' : 'Kirim Pesanan'}
              </button>
            </form>
          )}
        </div>
