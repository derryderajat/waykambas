...
export default function RoomDetail({ roomId, onBack }: RoomDetailProps) {
  ...
  if (!room) {
    return (
      ...
      >
        <p style={{ fontSize: '20px' }}>Paket tour tidak ditemukan.</p>
        <button
          onClick={onBack}
          style={{
            fontSize: '13px',
    ...
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh' }}>
      ...
      >
        ...
        >
          ...
          >
            <Row k="Durasi" v={room.sqm} />
            <Row k="Kapasitas" v={room.occupancy} />
            <Row k="Tingkat" v={room.bed} />
          </dl>
          ...
          {reserveStatus === 'reserved' ? (
            ...
            >
              Reservasi berhasil dikirim. Tim kami akan segera menghubungi Anda.
            </div>
          ) : (
            <button
            ...
            >
              {createReservation.isPending ? 'Mengirim...' : 'Pesan Paket Ini'}
            </button>
          )}
          <button
            onClick={onBack}
